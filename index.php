		...
		<div class="sfooter-content"></div>
			...
			<section>
				<div class="container">
					...
					<!-- WELCOME IMAGE -->
					<div class="welcome">
					<img src="images/welcome.gif" alt="welcome to my homepage" width="500" height="173">
				    </div>
					<div class="instructions-wrapper">
						...
						<img class="resize" src="images/captain-janeway.png" alt="captain janeway"  />
			...
			<section class="about-me">
				<div class="container1">
					<img src="images/stunning.jpg" alt="captain picard" width="190" height="150" />
